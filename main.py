...
def deleteItem():
    ...
    try:
        ...
        print(f"ERROR: Unable to remove item ({e}). Provide a valid index.")
...
group.add_argument("--add", nargs=1, type=str, help="Add a new task to the todo list.")
...
group.add_argument(
    ...
    nargs=2,
    type=str,
    help="Update an existing task. Provide index and task name.",
)
